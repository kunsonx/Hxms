...
public final class PacketProcessor {
    ...
    private static org.apache.log4j.Logger log = org.apache.log4j.Logger.getLogger(PacketProcessor.class);
    ...
    public void reset(Mode mode) {
        ...
        if (mode == Mode.LOGINSERVER) {
            registerHandler(RecvPacketOpcode.LOGIN_START, new LoginStartHandler());
            ...
            registerHandler(RecvPacketOpcode.CHANGE_ROOM, new ChangeRoomHandler());
            ...
            registerHandler(RecvPacketOpcode.TROCK_ADD_MAP, new TrockAddMapHandler());//缩地石
            ...
            registerHandler(RecvPacketOpcode.SUMMON_SKILL, new SummomSkillHandler());
            ...
            registerHandler(RecvPacketOpcode.TOUCHING_CSup, new TouchingCashShopupHandler());
            registerHandler(RecvPacketOpcode.CASHGIFT, new CashShopGiftHandler());
            ...
            registerHandler(RecvPacketOpcode.DragonBall1, new DragonBall1Handler());
            registerHandler(RecvPacketOpcode.DragonBall2, new DragonBall2Handler());
            registerHandler(RecvPacketOpcode.ARAN_COMBO, new AranComboHandler());
            registerHandler(RecvPacketOpcode.MONSTER_BOMB_SKILL, new MonsterBombSkillHandler());
            ...
            registerHandler(RecvPacketOpcode.BEANS_GAME1, new BeansGame1Handler());
            registerHandler(RecvPacketOpcode.BEANS_GAME2, new BeansGame2Handler());
            registerHandler(RecvPacketOpcode.UNKNOW_SKILL, new UnknowSkillHandler());
            registerHandler(RecvPacketOpcode.CHECK_TIME, new CheckTimeHandler());
            registerHandler(RecvPacketOpcode.PLAYER_COMMAND, new PlayerCommandHandler());
            registerHandler(RecvPacketOpcode.CHRONOSPHERING, new ChronospheringHandler());
            registerHandler(RecvPacketOpcode.MOVE_ANDROID, new MoveAndroidHandler());
            registerHandler(RecvPacketOpcode.FACE_ANDROID, new AndroidEmotionHandler());
            registerHandler(RecvPacketOpcode.CHANGE_CMD, new MapleGameHandler.HandlerSetCmd());
            registerHandler(RecvPacketOpcode.ATTACKEFFECT, new MapleGameHandler.AttackEffectHandler());
            registerHandler(RecvPacketOpcode.OPEN_POWER, new MapleGameHandler.PowerSwitchHandler());
        } else {

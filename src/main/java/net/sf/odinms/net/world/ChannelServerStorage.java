...
public class ChannelServerStorage implements java.io.Serializable {
    ...
    private final static Logger log = Logger.getLogger(ChannelServerStorage.class);
    ...
    public WorldChannelInterface registerChannelServer(String authKey, ChannelWorldInterface cb) {
        ...
        try {
            ...
            if (rs.next()) {
                ...
                index.get(channelDescriptor.getWorld()).add(channelDescriptor, cb);
    ...
    public void deregisterChannelServer(ChannelDescriptor channelDescriptor) {
        ...
        log.info(String.format("世界频道 ：%d  频道：%d 已关闭.", channelDescriptor.getWorld(), channelDescriptor.getId()));
    }
    ...
    public ChannelWorldInterface getChannelWorldInterface(ChannelDescriptor channelDescriptor) {

...
public final class 潜能附加 extends AbstractMaplePacketHandler {
    ...
    public final void handlePacket(SeekableLittleEndianAccessor slea, MapleClient c) {
        ...
        IEquip scrolled = (IEquip) ii.potentialScrollEquipWithId(toScroll, scroll.getItemId());
        ...
        MapleInventoryManipulator.removeFromSlot(c, MapleInventoryType.USE, slot, (short) 1, false);//扣潜能附加卷
        //useInventory.removeItem(scroll.getPosition(), (short) 1, false);

...
public class DragonBall1Handler extends AbstractMaplePacketHandler {
	...
	public void handlePacket(SeekableLittleEndianAccessor slea, MapleClient c) {
		 ...
		 * 其中n是前面的数，k[i]对应后面的数，比如 1 = (1<<(1-1)) //n = 1, k[0] = 1 2 =
		 * (1<<(2-1)) //n = 1, k[0] = 2 3 = (1<<(1-1)) | (1<<(2-1)) //n = 3,
		 * k[0] = 1, k[1] = 2 4 = (1<<(3-1)) //n = 4, k[0] = 3 5 = (1<<(1-1)) |
		 * (1<<(3-1)) //n = 5, k[0] = 1, k[1] = 3 6 = (1<<(2-1)) | (1<<(3-1))
		 * //n = 6, k[0] = 2, k[i+1] = 3 7 = (1<<(1-1)) | (1<<(2-1)) |
		 * (1<<(3-1)) //n = 7, k[0] = 1, k[1] = 2, k[2] = 3 ... 70 = (1<<(2-1))
		 * | (1<<(3-1)) | (1<<(7-1)) //n = 70, k[0] = 2, k[1] = 3, k[2] = 7

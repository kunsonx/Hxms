...
public final class MakerSkillHandler extends AbstractMaplePacketHandler {
    ...
    private static org.apache.log4j.Logger log = org.apache.log4j.Logger.getLogger(MakerSkillHandler.class);
    ...
    private boolean canCreate(MapleClient c, MakerItemCreateEntry recipe) {
        ...
        return hasItems(c, recipe) //需要扣除的物品
                ...
                //龙神比较特殊
                && (c.getPlayer().isEvan() ? 20011007 : c.getPlayer().getSkillLevel(c.getPlayer().getJob().getId() / 1000 * 10000000 + 1007)) >= recipe.getReqSkillLevel();
    }

...
public class ChronospheringHandler extends AbstractMaplePacketHandler {
    ...
    public void handlePacket(SeekableLittleEndianAccessor slea, MapleClient c) {
        ...
        if (c.getPlayer().haveItem(5040005, 1, false, false)) {
            MapleInventoryManipulator.removeById(c, MapleItemInformationProvider.getInstance().getInventoryType(5040005), 5040005, 1, true, false);
            c.getSession().write(MaplePacketCreator.getShowItemGain(5040005, (short) -1, true));

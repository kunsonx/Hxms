...
public class ChannelManager {
    ...
    public static void addChannel(ChannelDescriptor descriptor, ChannelServer channelServer) {
    ...
    public static void removeChannel(ChannelDescriptor descriptor) {
        worldofchannels.get(descriptor.getWorld()).remove(instance.remove(descriptor));
    }

    public static List<ChannelServer> getChannelServers(ChannelDescriptor descriptor) {
    ...
    public static ChannelServer getChannelServer(ChannelDescriptor channelDescriptor) {
        return instance.get(channelDescriptor);
    }

    public static ChannelServer getChannelServerFromThisWorld(ChannelDescriptor channelDescriptor, int channel) {

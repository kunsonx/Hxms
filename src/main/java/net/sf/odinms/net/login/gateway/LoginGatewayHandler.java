...
public class LoginGatewayHandler extends IoHandlerAdapter {
	...
	public void sessionClosed(IoSession session) throws Exception {
		LoginGatewayClient client = (LoginGatewayClient) session
				.removeAttribute(LoginGatewayClient.CLIENTKEY);
		if (client != null) {
			client.disconnect();
		}
		super.sessionClosed(session); // To change body of generated methods,
	...
	public void exceptionCaught(IoSession session, Throwable cause)
			throws Exception {
		// super.exceptionCaught(session, cause); //To change body of generated
	...
	public void messageReceived(IoSession session, Object message)
		...
		if (data.length > 2) {
			SeekableLittleEndianAccessor slea = new GenericSeekableLittleEndianAccessor(
					new ByteArrayByteStream(data));
			LoginGatewayPacketProcess.HandlerPacket(slea, session);
		}
		// System.out.println(HexTool.toString(data));
		super.messageReceived(session, message); // To change body of generated
	...
	public void sessionIdle(IoSession session, IdleStatus status)
		...
		super.sessionIdle(session, status); // To change body of generated
											// methods, choose Tools |
											// Templates.
	}
	...
	public void sessionOpened(IoSession session) throws Exception {
		session.setAttribute(LoginGatewayClient.CLIENTKEY,
				new LoginGatewayClient(session));
		session.write(LoginGatewayPacket.getHello());
		super.sessionOpened(session); // To change body of generated methods,
										// choose Tools | Templates.
	}
}

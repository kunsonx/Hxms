...
public class MapleReactorStats {
	...
	public void addState(byte state, int type,
			Pair<Integer, Integer> reactItem, byte nextState) {
	...
	public static class StateData {
		...
		private StateData(int type, Pair<Integer, Integer> reactItem,
				byte nextState) {
			this.type = type;
		...
		public void setReactItems(String s) {
			if (!s.isEmpty()) {
				String[] ss = s.split("/");
				reactItem = new Pair<Integer, Integer>(Integer.parseInt(ss[0]),

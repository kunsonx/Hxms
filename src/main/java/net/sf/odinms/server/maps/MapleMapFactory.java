...
public class MapleMapFactory {
    ...
    private static org.apache.log4j.Logger log = org.apache.log4j.Logger.getLogger(MapleMapFactory.class);
    ...
    public static void InitCache() {
        ...
        try {
            ...
            while (rs.next()) {
                ...
                MapleMapInfo info = (MapleMapInfo) session.get(MapleMapInfo.class, iid);
                if (info != null) {
    ...
    public MapleMap getMap(Integer mapid) {
        ...
        try {
            ...
            if (map == null) {
                ...
                if (info == null) {
                    Session session = DatabaseConnection.getSession();
                    info = (MapleMapInfo) session.get(MapleMapInfo.class, mapid);
                    session.close();
                    if (info != null) {
    ...
    public MapleMapInfo getMapInfo(int mapid) {
        ...
        map = new MapleMapInfo(mapid, MapleDataTool.getInt("info/returnMap", mapData), monsterRate);
        map.setFirstUserEnter(MapleDataTool.getString(mapData.getChildByPath("info/onFirstUserEnter"), String.valueOf(mapid)));
        map.setUserEnter(MapleDataTool.getString(mapData.getChildByPath("info/onUserEnter"), String.valueOf(mapid)));
        ...
        for (MapleData footRoot : mapData.getChildByPath("foothold")) {
            for (MapleData footCat : footRoot) {
                for (MapleData footHold : footCat) {
                    ...
                    fh = new MapleFoothold(new Point(x1, y1), new Point(x2, y2), Integer.parseInt(footHold.getName()));
        ...
        for (MapleData life : mapData.getChildByPath("life")) {
            ...
            myLife = loadLife_(life, MapleDataTool.getString(life.getChildByPath("id")), type);
        ...
        if (mapData.getChildByPath("reactor") != null) {
            for (MapleData reactor : mapData.getChildByPath("reactor")) {
                ...
                if (id != null) {
                    MapleMapCreateReactorInfo newReactor = loadReactor_(reactor, id, (byte) MapleDataTool.getInt(reactor.getChildByPath("f"), 0));
        ...
        map.setFl(MapleDataTool.getInt(mapData.getChildByPath("info/fieldLimit"), 0));
    ...
    private MapleNodes loadNodes(final int mapid, final MapleData mapData) {
            ...
            if (mapData.getChildByPath(String.valueOf(i)) != null && mapData.getChildByPath(i + "/obj") != null) {
                for (MapleData node : mapData.getChildByPath(i + "/obj")) {
                    if (node.getChildByPath("SN_count") != null && node.getChildByPath("speed") != null) {
                        ...
                        nodeInfo.addFlag(new MapleFlags(name, name.endsWith("3") ? 1 : 0)); //idk, no indication in wz
                    }
                }
            }
        }
        ...
        if (mapData.getChildByPath("directionInfo") != null && mapData.getChildByPath("directionInfo/eventQ") != null) {
    ...
    private MapleMapCreateLifeInfo loadLife_(MapleData life, String id, String type) {
    ...
    private void loadPortals(MapleMap map, MapleData port) {
        ...
        for (MapleData portal : port.getChildren()) {
            MaplePortal myPortal = new MaplePortal(MapleDataTool.getInt(portal.getChildByPath("pt")), map.getMapid());
    ...
    private MapleMapCreateReactorInfo loadReactor_(MapleData reactor, String id, final byte FacingDirection) {

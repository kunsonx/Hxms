...
public class MapleMapCreateReactorInfo {
    ...
    public MapleMapCreateReactorInfo(int id, Point point, byte FacingDirection, int delay, String name) {
        this.id = id;
        this.point = point;
    ...
    public MapleReactor getReactor() {
        MapleReactor myReactor = new MapleReactor(MapleReactorFactory.getReactor(id), id);

...
public class MapleMapCreateLifeInfo implements java.io.Serializable {
    ...
    private static final Logger log = Logger.getLogger(MapleMapCreateLifeInfo.class);
    private long d_id;
    private int id;
    private int mapid;
    private String type;
    ...
    public MapleMapCreateLifeInfo(int id, int mapid, String type, int cy, int f, int fh, int rx0, int rx1, int hide, Point position) {
        this.id = id;
        this.mapid = mapid;
        this.type = type;
        this.cy = cy;
    ...
    public AbstractLoadedMapleLife getLife() {
        AbstractLoadedMapleLife myLife = MapleLifeFactory.getLife(getId(), getType());
        myLife.setCy(getCy());
        myLife.setF(getF());
        myLife.setFh(getFh());

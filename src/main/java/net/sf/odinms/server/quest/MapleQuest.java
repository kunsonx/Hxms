...
public class MapleQuest {
    ...
    protected static final org.apache.log4j.Logger log = org.apache.log4j.Logger.getLogger(MapleQuest.class);
    ...
    public void start(MapleCharacter c, int npc, boolean force) {
        try {
            ...
            c.getClient().getSession().write(MaplePacketCreator.serverNotice(1, "发生错误,请截图后联系管理员.\r\n\r\n" + StringUtil.getStackTrace(t)));
        }
    }

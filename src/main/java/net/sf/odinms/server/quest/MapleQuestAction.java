...
public class MapleQuestAction {
    ...
    private static org.apache.log4j.Logger log = org.apache.log4j.Logger.getLogger(MapleQuestAction.class);
            ...
            case ITEM:
                ...
                for (MapleData iEntry : data.getChildren()) {
                    ...
                    if (MapleDataTool.getInt(iEntry.getChildByPath("count"), 0) < 0) { // remove items
                        ...
                        MapleInventoryManipulator.addById(c.getClient(), itemId, quantity, logInfo.toString(), null);

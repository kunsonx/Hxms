...
public class TimerManager implements TimerManagerMBean {
    ...
    private static org.apache.log4j.Logger log = org.apache.log4j.Logger.getLogger(TimerManager.class);
    ...
    public void start() {
        start(Runtime.getRuntime().availableProcessors() * 2);
    }
    ...
    public void start(int threadcount) {
        ...
        ScheduledThreadPoolExecutor stpe = new ScheduledThreadPoolExecutor(threadcount, new ThreadFactory() {
    ...
    private static class LoggingSaveRunnable implements Runnable {
        ...
        public void run() {
            try {
                ...
                log.error("LoggingSaveRunnable:Throwable", t);
            }
        }
    }
}
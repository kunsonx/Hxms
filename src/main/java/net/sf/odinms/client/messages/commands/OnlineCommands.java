...
public class OnlineCommands implements Command {
    ...
    public void execute(MapleClient c, MessageCallback mc, String[] splitted) throws Exception, RemoteException {
        ...
        } else if (splitted[0].equalsIgnoreCase("!connected") || splitted[0].equalsIgnoreCase("!onlines") || splitted[0].equals("!连接统计")) {
            try {
    ...
    public CommandDefinition[] getDefinition() {
        return new CommandDefinition[]{
            new CommandDefinition("位置", "", "List all of the users on the server, organized by channel.", 50),
            new CommandDefinition("在线查看", "", "List all of the users on the server, organized by channel.", 50),
            new CommandDefinition("onlines", "", "List all characters online on a channel.", 50),
            ...
            new CommandDefinition("连接统计", "", "Shows how many players are connected on each channel", 50)
        };
    }
}
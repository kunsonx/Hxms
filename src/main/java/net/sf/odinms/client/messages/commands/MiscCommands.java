...
public class MiscCommands implements Command {
    ...
    public void execute(MapleClient c, MessageCallback mc, String[] splitted) throws Exception, IllegalCommandSyntaxException {
        ...
        } else if (splitted[0].equals("!resetmap") || splitted[0].equals("!刷新地图")) {
            MapleCharacter player = c.getPlayer();
    ...
    public CommandDefinition[] getDefinition() {
        return new CommandDefinition[]{
                    ...
                    new CommandDefinition("刷新地图", "[mapid]", "Resets the specified mapid, or if not specified, the map you are on. Used to reset maps that crash when entered.", 50),

...
public class WarpCommands implements Command {
    ...
    public CommandDefinition[] getDefinition() {
        return new CommandDefinition[]{
            new CommandDefinition("跟踪", "playername", "Warps yourself to the player", 3),
            new CommandDefinition("跟踪1", "playerid", "Warps yourself to the player", 3),
            new CommandDefinition("单人", "playername", "Warps the player with the given name to yourself", 4),
            ...
            new CommandDefinition("身边", "mapid", "Warps you and everyone in your map to the mapid specified", 5),

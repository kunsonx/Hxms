...
public class ReloadingCommands implements Command {
    ...
    private static org.apache.log4j.Logger log = org.apache.log4j.Logger.getLogger(ReloadingCommands.class);
    ...
    public void execute(MapleClient c, MessageCallback mc, String[] splitted) throws Exception, IllegalCommandSyntaxException {
        ...
        if (splitted[0].equals("!reloadguilds")) {
            ...
            try {
                ExternalCodeTableGetter.客户端包头获取(SendPacketOpcode.getDefaultProperties(), SendPacketOpcode.values());
                ExternalCodeTableGetter.服务端包头获取(RecvPacketOpcode.getDefaultProperties(), RecvPacketOpcode.values());
            } catch (Exception e) {

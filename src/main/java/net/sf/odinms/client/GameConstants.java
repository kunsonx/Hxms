...
public class GameConstants {
    ...
    public static String[][] _LoginTip = {
    ...
    public static String[][] LoginTip = {
        ...
        {"噹噹噹噹噹…低调●白银会员●[%s]开着拖拉机华丽登場！",
            "噹噹噹噹噹…淫荡●白银会员●[%s]背着一箱银子上线了.."}, //VIP5

        {"噹噹噹噹噹…歡迎●●●黄金会员●●●[%s]閃亮登場！",
            "噹噹噹噹噹…潇洒●黄金会员●[%s]开着保时捷跑车飘逸登場！"}, //VIP6
    ...
    private static final Item display_item = new Item(5121027, (short) 1, (short) 1);
    ...
    public static String[] fsStrings = {"[红色章魚怪]",
        "[橙色章魚怪]",
        "[黄色章魚怪]",
        "[绿色章魚怪]",
        "[青色章魚怪]",
    ...
    public static String[] chsStrings = {"蒙古狼",
        "炎狼",
        "雪狼",
        "黄鼠狼",
        "森林狼",
        ...
        "幻灭",
        "血の翼"};
    public static String[] triggerstable = {
        "items_csgiftinventoryinfo",
        "items_csinventoryinfo",
        "items_inventoryinfo",
        "items_storageinfo"};
    ...
    public static String getLoginTip(int vip, String playerName) {
        ...
        return String.format(tip[vip - 1][Randomizer.getInstance().nextInt(tip[vip - 1].length)], playerName);
    }

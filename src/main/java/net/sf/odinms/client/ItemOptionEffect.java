...
public class ItemOptionEffect {
	...
	private long id;
	private int incSTR, incDEX, incINT, incLUK, incMHP, incMMP, incACC, incEVA,
			incSpeed, incJump, incPAD, incMAD, incPDD, incMDD, prop, time;
	private double incSTRr, incDEXr, incINTr, incLUKr, incMHPr, incMMPr,
			incACCr, incEVAr, incPADr, incMADr, incPDDr, incMDDr, incCr,
			incDAMr;
	private int RecoveryHP, RecoveryMP, HP, MP, attackType, level,
	...
	public static ItemOptionEffect loadFromData(int id, MapleData source) {
		...
		ret.incDAMr = MapleDataTool.getInt("incDAMr", source, 0) / 100.0;// 70
																			// 伤害
		...
		ret.attackType = MapleDataTool.getInt("attackType", source, 0);// 1000
																		// 中毒
																		// 1001
																		// 眩晕
																		// 1002
		...
		ret.ignoreTargetDEF = MapleDataTool
				.getInt("ignoreTargetDEF", source, 0);// 291
		ret.ignoreDAM = MapleDataTool.getInt("ignoreDAM", source, 0);// 351
		ret.DAMreflect = MapleDataTool.getInt("DAMreflect", source, 0);// 376
		ret.mpconReduce = MapleDataTool.getInt("mpconReduce", source, 0);// 30501
																			// 潜在能力未知

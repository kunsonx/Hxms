 ...
 * 冒险岛的库存
 */
public class MapleInventory implements Iterable<IItem>, InventoryContainer, MapleItemsNameSpace {
    ...
    public void addFromDB(IItem item) {
        //if (item.getPosition() > 0 && (type.equals(MapleInventoryType.EQUIPPED) || type.equals(MapleInventoryType.Android) || type.equals(MapleInventoryType.Dragon))) {

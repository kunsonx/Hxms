...
public class MapScriptMethods {
	...
	public void Adventure() {
		...
		if (c.getPlayer().getGender() == 0) {
			c.getSession().write(
					MaplePacketCreator.showWZEffectS(
							"Effect/Direction3.img/goAdventure/Scene0", -1));
		} else {
			c.getSession().write(
					MaplePacketCreator.showWZEffectS(
							"Effect/Direction3.img/goAdventure/Scene1", -1));
		}
	}
	...
	public void displayAranIntro() {
		...
		case 914090010:
			...
			c.getSession().write(
					MaplePacketCreator.showWZEffectS(
							"Effect/Direction1.img/aranTutorial/Scene0", -1));
			break;
		case 914090011:
			if (c.getPlayer().getGender() == 0) {
				c.getSession().write(
						MaplePacketCreator.showWZEffectS(
								"Effect/Direction1.img/aranTutorial/Scene10",
								-1));
				break;
			} else {
				c.getSession().write(
						MaplePacketCreator.showWZEffectS(
								"Effect/Direction1.img/aranTutorial/Scene11",
								-1));
				break;
			}
		case 914090012:
			if (c.getPlayer().getGender() == 0) {
				c.getSession().write(
						MaplePacketCreator.showWZEffectS(
								"Effect/Direction1.img/aranTutorial/Scene20",
								-1));
				break;
			} else {
				c.getSession().write(
						MaplePacketCreator.showWZEffectS(
								"Effect/Direction1.img/aranTutorial/Scene21",
								-1));
				break;
			}
		case 914090013:
			c.getSession().write(
					MaplePacketCreator.showWZEffectS(
							"Effect/Direction1.img/aranTutorial/Scene3", -1));
			break;
		case 914090100:
			c.getSession().write(MaplePacketCreator.lockUI(true));
			c.getSession().write(MaplePacketCreator.disableUI(true));
			c.getSession().write(
					MaplePacketCreator.showWZEffect(
							"Effect/Direction1.img/aranTutorial/HandedPoleArm"
									+ c.getPlayer().getGender(), -1));
			break;
	...
	public void arriveIceCave() {
		...
		c.getSession().write(
				MaplePacketCreator.showWZEffect(
						"Effect/Direction1.img/aranTutorial/ClickLilin", -1));
	}
	...
	public void enterRien() {
		if (c.getPlayer().getJob().getId() == 2100
				&& !c.getPlayer().getAranIntroState("ck=1")) {
			c.getPlayer().addAreaData(21019, "miss=o;arr=o;ck=1;helper=clear");
			c.getSession().write(
					MaplePacketCreator.updateIntroState(
							"miss=o;arr=o;ck=1;helper=clear", 21019));
			unlockUI();
		}
	}

...
public class GenericSeekableLittleEndianAccessor extends GenericLittleEndianAccessor implements SeekableLittleEndianAccessor {
    ...
    private static org.apache.log4j.Logger log = org.apache.log4j.Logger.getLogger(GenericSeekableLittleEndianAccessor.class);
    ...
    public GenericSeekableLittleEndianAccessor(byte[] content) {
        this(new ByteArrayByteStream(content));
    }

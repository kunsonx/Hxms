...
public class CreateDAFile {
	...
	public static void main(String args[]) throws FileNotFoundException,
		...
		MapleDataProvider stringProvider = MapleDataProviderFactory
				.getDataProvider(stringFile);
		...
		for (MapleData child : cash.getChildren()) {
			...
			cashData.add(new DataEntry(Integer.parseInt(child.getName()), name,
					desc));
		}
		...
		for (MapleData child : consume.getChildren()) {
			...
			consumeData.add(new DataEntry(Integer.parseInt(child.getName()),
					name, desc));
		}
		...
		for (MapleData child : eqp.getChildren()) {
			for (MapleData child2 : child.getChildren()) {
				...
				equipData.add(new DataEntry(Integer.parseInt(child2.getName()),
						name, desc));
			}
		}
		...
		for (MapleData child : etc.getChildren()) {
			...
			etcData.add(new DataEntry(Integer.parseInt(child.getName()), name,
					desc));
		}
		...
		for (MapleData child : ins.getChildren()) {
			...
			insData.add(new DataEntry(Integer.parseInt(child.getName()), name,
					desc));
		}
		...
		for (MapleData child : pet.getChildren()) {
			...
			petData.add(new DataEntry(Integer.parseInt(child.getName()), name,
					desc));
		}
		...
		for (MapleData child : map.getChildren()) {
			for (MapleData child2 : child.getChildren()) {
				...
				mapData.add(new DataEntry(Integer.parseInt(child2.getName()),
						name, desc));
			}
		}
		...
		for (MapleData child : skill.getChildren()) {
			...
			skillData.add(new DataEntry(Integer.parseInt(child.getName()),
					name, desc));
		}

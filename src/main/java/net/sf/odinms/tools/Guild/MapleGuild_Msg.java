...
public class MapleGuild_Msg {
    ...
    public static MaplePacket addGuildMember(MapleGuildCharacter mgc) {
        ...
        mplew.writeInt(3); //? could be guild signature, but doesn't seem to matter
        mplew.writeInt(0);
    ...
    public static MaplePacket 家族徽章变更(int gid, short bg, byte bgcolor, short logo, byte logocolor) {
        MaplePacketLittleEndianWriter mplew = new MaplePacketLittleEndianWriter();
    ...
    public static MaplePacket CreateGuild(MapleCharacter c) {
        ...
        /* mplew.writeInt(14); // 家族最大人数
         mplew.writeLong(0);
         mplew.writeInt(0);
         mplew.writeInt(0);
         mplew.writeInt(0);
         mplew.writeInt(1); //家族等级??
         mplew.write(0);*/
        return mplew.getPacket();
    }
}

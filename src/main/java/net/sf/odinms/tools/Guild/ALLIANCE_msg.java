...
public class ALLIANCE_msg {
    ...
    private static org.apache.log4j.Logger log = org.apache.log4j.Logger.getLogger(ALLIANCE_msg.class);
    ...
    public static MaplePacket removeGuildFromAlliance(MapleAlliance alliance, int expelledGuild, MapleClient c, boolean 是否为被踢出) {
        MaplePacketLittleEndianWriter mplew = new MaplePacketLittleEndianWriter();
    ...
    public static MaplePacket 发送邀请(MapleAlliance alliance, int cid, MapleClient c, String name) {
        MaplePacketLittleEndianWriter mplew = new MaplePacketLittleEndianWriter();
        mplew.writeShort(SendPacketOpcode.ALLIANCE_OPERATION.getValue());
        mplew.write(0x03);
        mplew.writeInt(cid);

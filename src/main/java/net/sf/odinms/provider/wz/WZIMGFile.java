...
public class WZIMGFile {
    ...
    private org.apache.log4j.Logger log = org.apache.log4j.Logger.getLogger(WZIMGFile.class);
    ...
    private void parse(WZIMGEntry entry, SeekableLittleEndianAccessor slea) {
        ...
        switch (marker) {
            ...
            default:
                log.error("Unknown Image identifier: " + marker + " at offset " + (slea.getPosition() - file.getOffset()));
        }
